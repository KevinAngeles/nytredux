        ...
        <div className="panel panel-primary">
          <div className="panel-heading">
            <h3 className="panel-title">
              Search articles on The New York Times
            </h3>
          </div>
          <form className="panel-body text-center">
            <div className="panel-form-group">
              ...
              <input
                ...
                id="topic"
                placeholder="Topic"
                onChange={(e) => this.props.setKeyword(e)}
                value={this.props.keyWord}
              />
              {this.props.inputErrors.keyWord.status ? (
                <div className="alert alert-danger">
                  <strong>Error!</strong> {this.props.inputErrors.keyWord.msg}
                </div>
              ) : (
                ""
              )}
            ...
            <div className="form-group">
              ...
              <div>
                <SingleDatePicker
                  ...
                  onFocusChange={({ focused }) =>
                    this.props.setBeginDateFocus(focused)
              ...
              {this.props.inputErrors.beginDate.status ? (
                <div className="alert alert-danger">
                  <strong>Error!</strong> {this.props.inputErrors.beginDate.msg}
                </div>
              ) : (
                ""
              )}
            ...
            <div className="form-group">
              ...
              <div>
                <SingleDatePicker
                  ...
                  onFocusChange={({ focused }) =>
                    this.props.setEndDateFocus(focused)
                  } // PropTypes.func.isRequired
                  enableOutsideDays={false}
                  isOutsideRange={(day) =>
                    !isInclusivelyAfterDay(day, this.props.beginDate) ||
              ...
              {this.props.inputErrors.endDate.status ? (
                <div className="alert alert-danger">
                  <strong>Error!</strong> {this.props.inputErrors.endDate.msg}
                </div>
              ) : (
                ""
              )}
            ...
            <button
              ...
              onClick={(ev) => {
                this.props.validateAndFetchArticles(
                  this.props.keyWord,
